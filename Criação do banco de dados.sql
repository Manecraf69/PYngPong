...
CREATE TABLE `historico` (
  ...
  `jog_esquerda` varchar(16) DEFAULT NULL,
  `jog_direita` varchar(16) DEFAULT NULL,
...
CREATE TABLE `jogador` (
  ...
  `total_partida` int DEFAULT NULL,
  `nivel_habilidade` int DEFAULT NULL,
  `media_vitder` decimal(4,2) DEFAULT NULL,
...
-- Dump completed on 2022-10-07 23:05:36
